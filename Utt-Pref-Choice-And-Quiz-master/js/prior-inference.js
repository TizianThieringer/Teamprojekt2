...
//
//
    slides.EndExp_StartQuiz = slide({
        name: "EndExp_StartQuiz",
        button: function(){
            exp.go();
        }
    });
    
    slides.qinstructions = slide({
    name : "qinstructions",
    button : function() {
      exp.go(); //use exp.go() if and only if there is no "present" data.
    }
...
function hideQ_showR2_1() {
  ...
  var y = document.getElementById("showAnswer2");
...
function hideQ_showR2_2() {
  ...
  var y = document.getElementById("showAnswer2_2");
...
function hideQ_showR2_3() {
  ...
  var y = document.getElementById("showAnswer2_3");
...
function hideQ_showR2_4() {
  ...
  var y = document.getElementById("showAnswer2_4");
...
function hideQ_showR2_5() {
  ...
  var y = document.getElementById("showAnswer2_5");
...
function hideQ_showR3_1() {
  ...
  var y = document.getElementById("showAnswer3");
...
function hideQ_showR3_2() {
  ...
  var y = document.getElementById("showAnswer3_2");
...
function hideQ_showR3_3() {
  ...
  var y = document.getElementById("showAnswer3_3");
...
function hideQ_showR3_4() {
  ...
  var y = document.getElementById("showAnswer3_4");
...
function hideQ_showR3_5() {
  ...
  var y = document.getElementById("showAnswer3_5");
